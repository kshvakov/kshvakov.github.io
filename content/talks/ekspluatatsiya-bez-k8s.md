...
Здесь — причины отказа от Kubernetes, требования к системе, выбор решений и практический опыт эксплуатации более 50 серверов в 4 дата-центрах силами одного администратора.
...
Всё стандартными средствами ОС: пакетный менеджер для доставки, systemd для запуска и управления.
