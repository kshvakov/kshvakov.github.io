...
Jarvis — AI-помощник сотрудника Kinescope. Работает прямо в Cursor/Claude: ты пишешь в чат на обычном русском языке, а Jarvis сам обращается к Kaiten, находит нужную информацию и выполняет действия.
...
| Проверял качество описаний | "какие задачи без описания?" |
...
Проверит: есть ли описание, критерии приёмки, ответственный, зависимости. По каждому пункту — что выполнено, что нужно доработать.

> "какие задачи без описания на доске QA?"

Массовая проверка: покажет карточки без описания или с недостаточным описанием. Помогает понять, что не готово к тестированию.
...
Массовый аудит: какие карточки без описания, что доработать.
...
Массовая проверка: что не готово к разработке, что нужно доработать.
...
Definition of Ready: описание, AC, ответственный, зависимости. По каждому пункту — что ок, что доработать.
